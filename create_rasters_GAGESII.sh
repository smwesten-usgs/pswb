...
FQ_SHPFILE2=/home/nobody/NATIONAL_GEODATA/Quaternary_Atlas/NU_text_merged_w_PSU_CONUS_27JUN2016.shp
...
LOCAL_SHP="BASIN_OUTLINE__GAGE_ID_$POLYNAME.shp"
LOCAL_BASENAME="BASIN_OUTLINE__GAGE_ID_$POLYNAME"
...
/usr/bin/gdal_rasterize -a 'SWB_HSG' -te $EXTENTS -tr $RES $RES $FQ_SHPFILE2 $TEMPTIF1
...
# process the D8 flow direction file
