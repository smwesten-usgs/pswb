...
filename="huc8_list__problem_cases.txt"
...
swb_file=$(./create_rasters_huc8.sh $huc8 $RESOLUTION $START_DATE $END_DATE )
wait
...
tar --ignore-failed-read -cvf swb_logfiles_$proc_num.tar SWB_LOG* *.LOG
