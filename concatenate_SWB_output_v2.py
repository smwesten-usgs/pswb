...
mydir = '/run/media/smwesten/SCRATCH/SWB_RUN__8SEP2016/results'
#mydir = '/home/smwesten/Project_Data/NAWQA_GLASS/results'
#myworkdir = '/home/smwesten/Project_Data/NAWQA_GLASS/analyses'
myworkdir = '/run/media/smwesten/SCRATCH/temp__06SEP2016_run'
...
filelist = open( 'huc_list_recharge_vrt_v2.txt', 'w')
[filelist.write( filename + '\n' ) for filename in myrechargefiles]
filelist.close()

command_args = ['-input_file_list','huc_list_recharge_vrt_v2.txt','concatenated_swb_recharge_v2.vrt']
rc.run_cmd( command_text='gdalbuildvrt', command_arguments=command_args )

filelist = open( 'huc_list_gross_precip_vrt_v2.txt', 'w')
[filelist.write( filename + '\n' ) for filename in myprecipfiles]
filelist.close()

command_args = ['-input_file_list','huc_list_gross_precip_vrt_v2.txt','concatenated_swb_gross_precip_v2.vrt']
rc.run_cmd( command_text='gdalbuildvrt', command_arguments=command_args )
